    ...
    return (
        <div className='my-14'>
            ...
            <img 
             ...
             src={sponsorImg_1} alt='sponsor one image'/>
            <img 
             className='border p-2'
             src={sponsorImg_2} alt='sponsor tow image'/>
            <img 
             className='border p-2'
             src={sponsorImg_3} alt='sponsor three image'/>
            <img 
             className='border p-2'
             src={sponsorImg_4} alt='sponsor four image'/>
            <img 
             className='border p-2'
             src={sponsorImg_5} alt='sponsor five image'/>
            <img 
             className='border p-2'
             src={sponsorImg_6} alt='sponsor six image'/>
            <img 
             className='border p-2'
             src={sponsorImg_7} alt='sponsor seven image'/>
            <img 
             className='border p-2'
             src={sponsorImg_8} alt='sponsor eight image'/>
            </div>
        </div>
    );
};
